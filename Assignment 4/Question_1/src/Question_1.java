...
public class Question_1 {
    ...
    //    method that uses Back Tracking with Heuristics to find the subset sum
    ...
    //    method that uses Brute Force with Back Tracking to find the subset sum
    ...
    //    method to print the subsets of the problem
