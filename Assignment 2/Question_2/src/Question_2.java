...
// class that stores the nodes of the tree
class Node {
...
public class Question_2 {
    ...
    //    method that displays options to the user
    ...
    //    method that takes option input form the user and call the respective method
    ...
    //    method that shows the character codes generated by the tree
    ...
    //    method that shows the character frequencies (i.e: how many times a character is repeating in the file)
    ...
    //    method that displays the file data
    private static void showFileData(String fileData) {
        System.out.println("\nThe file data is: \n" + fileData);
    }

    //    method that read encoded data from the saved file
    private static StringBuilder readEncodedData() {
    ...
    //    method that calls the decodeFileData method that decodes the encoded data
    ...
    //    recursive method that decodes the encoded data
    ...
    //    method that encodes the file data into Huffman Codes
    ...
    //    method to store the Huffman Codes in the compressed.bin using bitwise left shift
    ...
    //    method that creates a tree for the Huffman Codes
    ...
    //    method that checks if the tree has a left node and returns a boolean value
    private static boolean isLeaf(Node root) {
        return root.left == null && root.right == null;
    }

    //    method that reads the tree and encode the data
    ...
    //    method that get all the characters of the Huffman tree and sort it
    ...
    //    method to store character codes in codes.txt file
    ...
    //    method to store character frequencies in frequency.txt file
    ...
    //    method to take file name from the user
